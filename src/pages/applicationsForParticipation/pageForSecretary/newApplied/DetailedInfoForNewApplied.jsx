    ...
    <div>
      ...
      {state === false ? (
        <div className={s.footer}>
          ...
          <ButtonForActiveChanges text="НЕТ" margin="0 0" width="210px" onClick={toggle} classname="yes_button"/>
          <ButtonForActiveChanges text="ДА" margin="0 30px" width="210px" classname="no_button"/>
        </div>
      ) : (
        <div className={s.second_footer}>
          ...
          <Input
            ...
            width="600px"
          />
          <Button text="ОТПРАВИТЬ" width="600px" margin="40px 0" onClick={toggle}/>
        </div>
      )}
    </div>
  );
