        ...
        <div className={ownStyles2.wrapper2}>
            ...
            <div className={ownStyles2.referee_cont}>
                ...
                <div className={ownStyles.input_cont} style={{fontWeight: "500", marginTop: 10}}>
                    ...
                    <input disabled className={ownStyles.title1} value="№"/>
                    <input disabled className={ownStyles.title2} value="Время"/>
                    <input disabled className={ownStyles.title} value="Подгруппа"/>
                    <input disabled className={ownStyles.title} value="Судейская бригада" />
                    <input disabled className={ownStyles.title} value="Арена" />

                </div>
                <div className={ownStyles.input_cont}>
                    <input className={ownStyles.input11} type="text" value="1"/>
                    <input className={ownStyles.input2} style={{width: 300}} type="text" value="08:00 - 08:30"/>
                    <input className={ownStyles.input} type="text" value="Мальчики, 8 - 12 лет"/>
                    <input className={ownStyles.input} type="text" value="Тестовчи, Тестовна, Нетесник "/>
