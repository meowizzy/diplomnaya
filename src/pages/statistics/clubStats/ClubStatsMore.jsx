  ...
  return (
    <>
        ...
        <span style={{width:"270px"}}>
            <PieChart />
            <p>Процент призовых мест
от общего кол-ва спортсменов</p>
        </span>
        <span style={{width:"270px"}}>
            <PieChart />
            <p>Процент призовых мест от кол-ва
заявленных спортсменов</p>
        </span>
        </div>
        ...
        <ForwardButton to='/main/statistics/clubStats/infoAthletes'/>
        </div>
        </div>
    </>
  )
